        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <motion.button
              ...
              transition={{ delay: 0.6 }}
              onClick={handleViewResume}
              className="bg-blue-600 hover:bg-blue-700 text-white block w-full text-left px-3 py-2 rounded-md text-base font-medium transition-colors duration-200 flex items-center gap-2"
            >
              View Resume
              <ExternalLink size={16} />
            </motion.button>
